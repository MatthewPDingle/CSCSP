...
//		METRICS.add("breakout200");
	...
	public static String MAP_COLOR_OPTION_ALL_GEOMEAN_PER_BAR = "All - Geo-Mean / Bar Return";
	...
	public static String MAP_COLOR_OPTION_ALL_ALPHA_GEOMEAN_PER_BAR = "All - Alpha Geo-Mean / Bar";
	...
	public static String MAP_COLOR_OPTION_METRIC_GEOMEAN_PER_BAR = "Metric - Geo-Mean / Bar Return";
	...
	public static String MAP_COLOR_OPTION_STOP_GEOMEAN_PER_BAR = "Stop - Geo-Mean / Bar Return";
	...
	public static String MAP_COLOR_OPTION_END_GEOMEAN_PER_BAR = "End - Geo-Mean / Bar Return";
	...
	static {
		...
		MAP_COLOR_OPTIONS.add(MAP_COLOR_OPTION_ALL_GEOMEAN_PER_BAR);
		...
		MAP_COLOR_OPTIONS.add(MAP_COLOR_OPTION_ALL_ALPHA_GEOMEAN_PER_BAR);
		...
		MAP_COLOR_OPTIONS.add(MAP_COLOR_OPTION_METRIC_GEOMEAN_PER_BAR);
		...
		MAP_COLOR_OPTIONS.add(MAP_COLOR_OPTION_STOP_GEOMEAN_PER_BAR);
		...
		MAP_COLOR_OPTIONS.add(MAP_COLOR_OPTION_END_GEOMEAN_PER_BAR);
	}
}